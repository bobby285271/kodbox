...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Увімкнути білий список IP",
    "admin.loginCheck.ipCheckDesc"   => "Після відкриття входити можуть лише користувачі із вказаним ip, будь ласка, працюйте з обережністю",
    "admin.loginCheck.ipAllow"       => "Дозволений IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Заповніть правила наступним чином (локальний IP-сервер сервера дозволений за замовчуванням, а системний адміністратор дозволяє IP-адресу LAN):</b></h5>
<li> Повний IP: збіг, якщо дорівнює, наприклад: 55.55.55.55</li>
<li> Префікс IP: ip починається з префікса та збігається; наприклад: 55.55</li>
<li> Інтервал IP: Два ips розділені тире, і ips збігаються в цьому інтервалі; наприклад: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "пріоритет",
    "admin.loginCheck.name"          => "Назва правила",
    "admin.loginCheck.user"          => "Призначений користувач",
    "admin.loginCheck.device"        => "Дозволити пристрій для входу",
