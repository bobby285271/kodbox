...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "IPホワイトリストを有効にする",
    "admin.loginCheck.ipCheckDesc"   => "開いた後は、指定したIPのユーザーのみログインできますのでご注意ください",
    "admin.loginCheck.ipAllow"       => "許可されたIP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>次のようにルールを入力します（サーバーのローカルIPはデフォルトで許可され、システム管理者はLAN IPを許可します）。</b></h5>
<li>完全なIP：等しい場合に一致します。例：55.55.55.55</li>
<li> IPプレフィックス：ipはプレフィックスで始まり、一致します。例：55.55</li>
<li> IP間隔：2つのIPはダッシュで分割され、IPはこの間隔内で一致します。例：55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "優先度",
    "admin.loginCheck.name"          => "ルール名",
    "admin.loginCheck.user"          => "指定ユーザー",
    "admin.loginCheck.device"        => "ログインデバイスを許可する",
