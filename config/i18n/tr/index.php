...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "IP beyaz listesini etkinleştir",
    "admin.loginCheck.ipCheckDesc"   => "Açtıktan sonra sadece belirtilen ip'e sahip kullanıcılar giriş yapabilir, lütfen dikkatli olun",
    "admin.loginCheck.ipAllow"       => "İzin verilen IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Kuralları aşağıdaki şekilde doldurun (sunucunun yerel IP'sine varsayılan olarak izin verilir ve sistem yöneticisi LAN IP'sine izin verir):</b></h5>
<li> Tam IP: eşitse eşleşir, örneğin: 55.55.55.55</li>
<li> IP öneki: ip, önek ile başlar ve eşleşir; örneğin: 55.55</li>
<li> IP aralığı: İki ips bir tireyle bölünür ve ips bu aralıkta eşleşir; örneğin: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "öncelik",
    "admin.loginCheck.name"          => "Kural adı",
    "admin.loginCheck.user"          => "Atanan kullanıcı",
    "admin.loginCheck.device"        => "Giriş cihazına izin ver",
