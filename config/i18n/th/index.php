...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "เปิดใช้งานรายการที่อนุญาตพิเศษของ IP",
    "admin.loginCheck.ipCheckDesc"   => "หลังจากเปิดแล้วเฉพาะผู้ใช้ที่มี ip ที่ระบุเท่านั้นที่สามารถเข้าสู่ระบบได้โปรดใช้งานด้วยความระมัดระวัง",
    "admin.loginCheck.ipAllow"       => "IP ที่อนุญาต",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>กรอกกฎดังต่อไปนี้ (IP ภายในของเซิร์ฟเวอร์ได้รับอนุญาตตามค่าเริ่มต้นและผู้ดูแลระบบอนุญาต LAN IP)</b></h5>
<li> IP แบบเต็ม: จับคู่ถ้าเท่ากันตัวอย่างเช่น 55.55.55.55</li>
<li> คำนำหน้า IP: ip เริ่มต้นด้วยคำนำหน้าและตรงกันตัวอย่างเช่น: 55.55</li>
<li> ช่วงเวลา IP: สอง ips ถูกหารด้วยเส้นประและ ips ตรงกันภายในช่วงเวลานี้ตัวอย่างเช่น: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "ลำดับความสำคัญ",
    "admin.loginCheck.name"          => "ชื่อกฎ",
    "admin.loginCheck.user"          => "ผู้ใช้ที่กำหนด",
    "admin.loginCheck.device"        => "อนุญาตอุปกรณ์เข้าสู่ระบบ",
