...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Включить белый список IP-адресов",
    "admin.loginCheck.ipCheckDesc"   => "После открытия войти могут только пользователи с указанным ip, будьте осторожны",
    "admin.loginCheck.ipAllow"       => "Разрешенный IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Заполните правила следующим образом (локальный IP-адрес сервера разрешен по умолчанию, а системный администратор разрешает IP-адрес LAN):</b></h5>
<li> Полный IP: совпадение, если оно равно, например: 55.55.55.55</li>
<li> Префикс IP: ip начинается с префикса и совпадает; например: 55,55</li>
<li> IP-интервал: два IP-адреса разделены тире, и IP-адрес соответствует этому интервалу; например: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "приоритет",
    "admin.loginCheck.name"          => "Название правила",
    "admin.loginCheck.user"          => "Назначенный пользователь",
    "admin.loginCheck.device"        => "Разрешить устройство входа",
