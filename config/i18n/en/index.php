...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Enable IP whitelist",
    "admin.loginCheck.ipCheckDesc"   => "After opening, only users with the specified ip can log in, please be careful",
    "admin.loginCheck.ipAllow"       => "Allowed IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Fill in the rules as follows (the server's local IP is allowed by default, and the system administrator allows the LAN IP):</b></h5>
<li> Full IP: match if equal, for example: 55.55.55.55</li>
<li> IP prefix: ip starts with the prefix and matches; for example: 55.55</li>
<li> IP interval: Two ips are divided by a dash, and ips match within this interval; for example: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "Priority",
    "admin.loginCheck.name"          => "Rule name",
    "admin.loginCheck.user"          => "Designated user",
    "admin.loginCheck.device"        => "Allow login device",
