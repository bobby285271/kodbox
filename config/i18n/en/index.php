...
return array(
    ...
    "admin.setting.passwordErrorLock" => "Password input error lock",
    "admin.setting.passwordErrorLockDesc" => "The password is incorrect for 5 consecutive times, and the account is not allowed to log in for 30s after being locked.After opening, it can effectively prevent brute force password cracking;",
    "admin.setting.passwordRule"     => "User password strength setting",
    "admin.setting.passwordRuleDesc" => "After the password strength is specified, the weak password can be effectively eliminated",
 ...
 ip interval: The two ips are divided by a dashed line; ip matches in this interval; <br/>",
    ...
    "ERROR_USER_LOGIN_LOCK"          => "Sorry, there are too many incorrect password attempts, the current account is locked, please try again in 30s!",
