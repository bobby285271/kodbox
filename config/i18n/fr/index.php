...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Activer la liste blanche IP",
    "admin.loginCheck.ipCheckDesc"   => "Après ouverture, seuls les utilisateurs avec l'IP spécifiée peuvent se connecter, veuillez faire attention",
    "admin.loginCheck.ipAllow"       => "IP autorisée",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Remplissez les règles comme suit (l'adresse IP locale du serveur est autorisée par défaut et l'administrateur système autorise l&#39;adresse IP du réseau local):</b></h5>
<li> IP complet: correspond si égal, par exemple: 55.55.55.55</li>
<li> Préfixe IP: ip commence par le préfixe et correspond; par exemple: 55,55</li>
<li> Intervalle IP: deux ips sont divisés par un tiret et les ips correspondent dans cet intervalle; par exemple: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "priorité",
    "admin.loginCheck.name"          => "Nom de la règle",
    "admin.loginCheck.user"          => "Utilisateur désigné",
    "admin.loginCheck.device"        => "Autoriser le périphérique de connexion",
