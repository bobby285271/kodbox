...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Aktivieren Sie die IP-Whitelist",
    "admin.loginCheck.ipCheckDesc"   => "Nach dem Öffnen können sich nur Benutzer mit der angegebenen IP anmelden. Seien Sie bitte vorsichtig",
    "admin.loginCheck.ipAllow"       => "Zulässige IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Füllen Sie die Regeln wie folgt aus (die lokale IP des Servers ist standardmäßig zulässig, und der Systemadministrator lässt die LAN-IP zu):</b></h5>
<li> Volle IP: Übereinstimmung, wenn gleich, zum Beispiel: 55.55.55.55</li>
<li> IP-Präfix: IP beginnt mit dem Präfix und stimmt überein, zum Beispiel: 55.55</li>
<li> IP-Intervall: Zwei ips werden durch einen Bindestrich geteilt, und ips stimmen innerhalb dieses Intervalls überein, z. B. 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "Priorität",
    "admin.loginCheck.name"          => "Regelname",
    "admin.loginCheck.user"          => "Designierter Benutzer",
    "admin.loginCheck.device"        => "Anmeldegerät zulassen",
