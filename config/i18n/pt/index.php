...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Habilitar lista de permissões de IP",
    "admin.loginCheck.ipCheckDesc"   => "Após a abertura, apenas usuários com o ip especificado podem fazer login, por favor, tome cuidado",
    "admin.loginCheck.ipAllow"       => "IP permitido",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Preencha as regras da seguinte forma (o IP local do servidor é permitido por padrão, e o administrador do sistema permite o IP da LAN):</b></h5>
<li> IP completo: corresponder se for igual, por exemplo: 55.55.55.55</li>
<li> Prefixo IP: o ip começa com o prefixo e corresponde; por exemplo: 55,55</li>
<li> Intervalo de IP: dois ips são divididos por um hífen e os ips correspondem dentro deste intervalo; por exemplo: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "prioridade",
    "admin.loginCheck.name"          => "Nome da regra",
    "admin.loginCheck.user"          => "Usuário designado",
    "admin.loginCheck.device"        => "Permitir dispositivo de login",
