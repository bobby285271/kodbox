...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Włącz białą listę adresów IP",
    "admin.loginCheck.ipCheckDesc"   => "Po otwarciu mogą się zalogować tylko użytkownicy z podanym adresem IP, należy zachować ostrożność",
    "admin.loginCheck.ipAllow"       => "Dozwolony adres IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Wypełnij reguły w następujący sposób (lokalny adres IP serwera jest domyślnie dozwolony, a administrator systemu zezwala na adres IP sieci LAN):</b></h5>
<li> Pełne IP: dopasuj, jeśli jest równe, na przykład: 55.55.55.55</li>
<li> Prefiks IP: ip zaczyna się od prefiksu i pasuje, na przykład: 55.55</li>
<li> Interwał IP: dwa ips są podzielone myślnikiem, a ips pasują do tego przedziału; na przykład: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "priorytet",
    "admin.loginCheck.name"          => "Nazwa reguły",
    "admin.loginCheck.user"          => "Wyznaczony użytkownik",
    "admin.loginCheck.device"        => "Zezwalaj na logowanie urządzenia",
