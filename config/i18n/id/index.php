...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Aktifkan daftar putih IP",
    "admin.loginCheck.ipCheckDesc"   => "Setelah dibuka, hanya pengguna dengan ip tertentu yang dapat masuk, harap berhati-hati",
    "admin.loginCheck.ipAllow"       => "IP yang Diizinkan",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Isi aturan sebagai berikut (IP lokal server diizinkan secara default, dan administrator sistem mengizinkan IP LAN):</b></h5>
<li> IP Lengkap: cocok jika sama, misalnya: 55.55.55.55</li>
<li> Awalan IP: ip dimulai dengan prefiks dan cocok; misalnya: 55.55</li>
<li> Interval IP: Dua ips dibagi dengan tanda hubung, dan ips cocok dengan interval ini; misalnya: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "prioritas",
    "admin.loginCheck.name"          => "Nama aturan",
    "admin.loginCheck.user"          => "Pengguna yang ditunjuk",
    "admin.loginCheck.device"        => "Izinkan perangkat masuk",
