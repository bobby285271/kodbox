...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Abilita whitelist IP",
    "admin.loginCheck.ipCheckDesc"   => "Dopo l'apertura, solo gli utenti con l'ip specificato possono accedere, fai attenzione",
    "admin.loginCheck.ipAllow"       => "IP consentito",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Compila le regole come segue (l'IP locale del server è consentito per impostazione predefinita e l'amministratore di sistema consente l&#39;IP LAN):</b></h5>
<li> IP completo: corrisponde se uguale, ad esempio: 55.55.55.55</li>
<li> Prefisso IP: ip inizia con il prefisso e corrisponde; ad esempio: 55.55</li>
<li> Intervallo IP: due ips sono divisi da un trattino e ips corrispondono all&#39;interno di questo intervallo; ad esempio: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "priorità",
    "admin.loginCheck.name"          => "Nome regola",
    "admin.loginCheck.user"          => "Utente designato",
    "admin.loginCheck.device"        => "Consenti dispositivo di accesso",
