...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "开启IP白名单",
    "admin.loginCheck.ipCheckDesc"   => "开启后,只允许指定ip的用户才能登录,请谨慎操作",
    "admin.loginCheck.ipAllow"       => "允许的IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>填写规则如下 (默认允许服务器本机IP,系统管理员允许局域网IP):</b></h5>
<li>完整IP: 相等则匹配, 例如:55.55.55.55</li>
<li>IP前缀: ip以前缀为开头则匹配;例如:55.55</li>
<li>IP区间段: 两个ip以中划线进行分割,ip在该区间内则匹配;例如:55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "优先级",
    "admin.loginCheck.name"          => "规则名称",
    "admin.loginCheck.user"          => "指定用户",
    "admin.loginCheck.device"        => "允许登陆设备",
