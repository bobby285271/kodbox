...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "IP 화이트리스트 활성화",
    "admin.loginCheck.ipCheckDesc"   => "개봉 후에는 지정된 IP를 가진 사용자 만 로그인이 가능하므로주의하여 사용하시기 바랍니다.",
    "admin.loginCheck.ipAllow"       => "허용 된 IP",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>다음과 같이 규칙을 입력하십시오 (서버의 로컬 IP는 기본적으로 허용되고 시스템 관리자는 LAN IP를 허용 함).</b></h5>
<li> 전체 IP : 같으면 일치 (예 : 55.55.55.55)</li>
<li> IP 접두사 : ip는 접두사로 시작하고 일치합니다 (예 : 55.55).</li>
<li> IP 간격 : 두 개의 ip는 대시로 나뉘고 ip는이 간격 내에서 일치합니다 (예 : 55.55.0.0-55.55.1.255).</li>",
    "admin.loginCheck.sort"          => "우선 순위",
    "admin.loginCheck.name"          => "규칙 이름",
    "admin.loginCheck.user"          => "지정된 사용자",
    "admin.loginCheck.device"        => "로그인 장치 허용",
