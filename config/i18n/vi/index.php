...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Bật danh sách trắng IP",
    "admin.loginCheck.ipCheckDesc"   => "Sau khi mở, chỉ người dùng có ip được chỉ định mới có thể đăng nhập, hãy cẩn thận",
    "admin.loginCheck.ipAllow"       => "IP được phép",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Điền vào các quy tắc như sau (IP cục bộ của máy chủ được cho phép theo mặc định và quản trị viên hệ thống cho phép IP LAN):</b></h5>
<li> IP đầy đủ: khớp nếu bằng nhau, ví dụ: 55.55.55.55</li>
<li> Tiền tố IP: ip bắt đầu bằng tiền tố và khớp; ví dụ: 55,55</li>
<li> Khoảng IP: Hai ips được chia bởi một dấu gạch ngang và ips khớp trong khoảng này; ví dụ: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "sự ưu tiên",
    "admin.loginCheck.name"          => "Tên quy tắc",
    "admin.loginCheck.user"          => "Người dùng được chỉ định",
    "admin.loginCheck.device"        => "Cho phép thiết bị đăng nhập",
