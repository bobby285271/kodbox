...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "Habilitar lista blanca de IP",
    "admin.loginCheck.ipCheckDesc"   => "Después de abrir, solo los usuarios con la IP especificada pueden iniciar sesión, tenga cuidado",
    "admin.loginCheck.ipAllow"       => "IP permitida",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>Complete las reglas de la siguiente manera (la IP local del servidor está permitida de forma predeterminada y el administrador del sistema permite la IP de LAN):</b></h5>
<li> IP completa: coincidir si es igual, por ejemplo: 55.55.55.55</li>
<li> Prefijo de IP: ip comienza con el prefijo y coincide; por ejemplo: 55.55</li>
<li> Intervalo de IP: dos ips se dividen por un guión y los ips coinciden dentro de este intervalo; por ejemplo: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "prioridad",
    "admin.loginCheck.name"          => "Nombre de la regla",
    "admin.loginCheck.user"          => "Usuario designado",
    "admin.loginCheck.device"        => "Permitir dispositivo de inicio de sesión",
