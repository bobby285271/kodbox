...
return array(
    ...
    "admin.loginCheck.ipCheck"       => "تفعيل القائمة البيضاء لعناوين IP",
    "admin.loginCheck.ipCheckDesc"   => "بعد الفتح ، يمكن فقط للمستخدمين الذين لديهم عنوان IP المحدد تسجيل الدخول ، يرجى العمل بحذر",
    "admin.loginCheck.ipAllow"       => "IP المسموح به",
    "admin.loginCheck.ipAllowDesc"   => "<h5 class=\"mb-15\"><b>املأ القواعد على النحو التالي (يُسمح بعنوان IP المحلي للخادم افتراضيًا ، ويسمح مسؤول النظام بـ LAN IP):</b></h5>
<li> IP الكامل: تطابق إذا كانت متساوية ، على سبيل المثال: 55.55.55.55</li>
<li> بادئة IP: يبدأ ip بالبادئة والمطابقات ؛ على سبيل المثال: 55.55.55</li>
<li> الفاصل الزمني لعنوان IP: يتم تقسيم اثنين من ips على شرطة ، ومطابقة ips داخل هذا الفاصل الزمني ؛ على سبيل المثال: 55.55.0.0-55.55.1.255</li>",
    "admin.loginCheck.sort"          => "أفضلية",
    "admin.loginCheck.name"          => "اسم القاعدة",
    "admin.loginCheck.user"          => "المستخدم المعين",
    "admin.loginCheck.device"        => "اسمح لجهاز تسجيل الدخول",
